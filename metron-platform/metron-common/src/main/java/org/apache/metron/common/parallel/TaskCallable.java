 ...
 */
public class TaskCallable<T> implements Callable<JSONObject>, Function<T, JSONObject> {
//  T key;
//  EnrichmentAdapter<T > adapter;

//  public TaskCallable( T key
...
//    return adapter.enrich(key);
   ...
   */
  @Override
  public JSONObject apply(T cacheKey) {
//    adapter.logAccess(key);
