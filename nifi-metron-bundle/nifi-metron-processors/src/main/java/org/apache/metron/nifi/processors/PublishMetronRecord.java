...
public class PublishMetronRecord extends AbstractPublishMetron {
  ...
  static final PropertyDescriptor RECORD_READER = new PropertyDescriptor.Builder()
      ...
      .identifiesControllerService(RecordReaderFactory.class).expressionLanguageSupported(false)
      .required(true)
      .build();
  ...
  static final PropertyDescriptor RECORD_WRITER = new PropertyDescriptor.Builder()
      ...
      .identifiesControllerService(RecordSetWriterFactory.class).expressionLanguageSupported(false)
      .required(true)
      .build();
  ...
  public void onTrigger(final ProcessContext context, final ProcessSession session)
    ...
    final List<FlowFile> flowFiles = session
        .get(FlowFileFilters.newSizeBasedFilter(1, DataUnit.MB, 500));
          ...
          session.read(flowFile, new InputStreamCallback() {
            ...
            public void process(final InputStream rawIn) throws IOException {
              try (final InputStream in = new BufferedInputStream(rawIn)) {
                ...
                final RecordSchema schema = writerFactory
                    .getSchema(attributes, recordSet.getSchema());
