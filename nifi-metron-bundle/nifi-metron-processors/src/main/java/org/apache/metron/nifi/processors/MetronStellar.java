...
public class MetronStellar extends AbstractProcessor {
  ...
  public static final PropertyDescriptor STELLAR_EXPRESSION = new PropertyDescriptor.Builder()
      .name("STELLAR")
      .displayName("Stellar Statement").description("The stellar statements to execute")
      .required(true)
      .expressionLanguageSupported(false).addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
      .build();

  public static final PropertyDescriptor EXTRA_CLASSPATH = new PropertyDescriptor.Builder()
      .name("EXTRA_CLASSPATH")
      .displayName("Stellar Extensions (urls)")
      .description(
          "Comma-separated list of URL to download stellar plugin jars containing custom functions")
  ...
  public static final PropertyDescriptor INCLUDE_CONTENT = new PropertyDescriptor.Builder()
      .name("INCLUDE_CONTENT")
      .displayName("Process content")
      .description(
          "Apply stellar on the content of flow files, or just the attributes of the flowfile")
  ...
  public void onTrigger(final ProcessContext context, final ProcessSession session)
    ...
    if (context.getProperty(INCLUDE_CONTENT).getValue() == DESTINATION_CONTENT) {
      ...
      Map<String, Object> results = processStatements(stellarStatements, processor,
  ...
  private static Map<String, Object> processStatements(Map<String, Object> stellarStatements,
    ...
    for (Entry<String, Object> kv : stellarStatements.entrySet()) {
      Object o = processor
          .parse(kv.getValue().toString(), variableResolver, functionResolver, stellarContext);
      if (o != null) {
        if (o instanceof Map) {
